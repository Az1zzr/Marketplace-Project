...
class getLivraisonControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.m3adcQT'] ?? $container->load('get_ServiceLocator_M3adcQTService'))->withContext('App\\Controller\\LivraisonController', $container));
