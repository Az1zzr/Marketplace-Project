 ...
 */
final class Version20260422195614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD created_at DATETIME NOT NULL, CHANGE id_role id_role INT DEFAULT NULL');
